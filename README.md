...
To use the API with CHORDS the supported CHORRDS docker app can be found here https://hub.docker.com/r/scleveland/chords/.  Just replace the base CHORDS docker app with it and the Tapis Chords API shouldn't have any CORS issues with chords.
